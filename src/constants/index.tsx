...
export const projects = [
  {
    ...
    image:
      "https://res.cloudinary.com/dr7lkelwl/image/upload/v1746041716/stories/dxjirlgwi3z0el9yfglc.webp",
    features: [
    ...
    link: "https://syncvibe.xyz",
    sourceCode: "https://github.com/thakurdotdev/syncvibe",
    color: "#3B82F6", // blue
  },
  {
    title: "SyncVibe App",
    ...
    image:
      "https://res.cloudinary.com/dr7lkelwl/image/upload/v1746043203/posts/g5p6hbc8oydobagidyeq.webp",
    features: [
      "Create and join rooms to listen to music together",
      "Search for songs and add them to the queue",
      "Real-time chat feature with notifications",
...
export const socialLinks = [
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/thakurdotdev",
    icon: <LinkedinSVG />,
  },
  {
    name: "Twitter",
