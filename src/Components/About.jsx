      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-10">
        <div className=" text-justify font-serif m-5 md:m-0 p-6 md:ml-5 mt-5 md:w-1/2">
          ...
          <p className="text-xl">
            ...
            <br />
            <br />
            My educational background includes a Bachelor of Engineering degree
            in Computer Engineering from Marwadi Education Foundation's Group of
            Institutions, Rajkot.
            <br />
            ...
            Tailwind CSS, Node.JS, Express.JS, MongoDB, Git, Github, Visual
            Studio Code, Netlify, and Vercel.
            <br />
