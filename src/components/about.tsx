      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="lg:col-span-2">
            <article className="border-2 border-gray-300 p-4 sm:p-6">
              ...
              <div className="space-y-4 sm:space-y-6 text-sm sm:text-base leading-relaxed">
                <p>
                  <span className="font-bold text-3xl sm:text-4xl float-left mr-2 sm:mr-3 leading-none">
                    H
                  </span>
                ...
                <div className="bg-gray-100 p-3 sm:p-4 border-l-4 border-black italic">
          ...
          <div className="space-y-6">
            <div className="border-2 border-gray-300 p-4 sm:p-6 transition-colors">
              ...
              <div className="space-y-4">
                {skills.map((skillCategory, index) => (
                  <div
                    key={index}
                    className="bg-gray-50 p-2 border-l-4 border-black"
                  >
